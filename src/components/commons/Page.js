...
export default function Page(props) {
    const { title,children,buttonTitle, ...others } = props
    return <>
        {/* Header */}
        <div className="border-b border-gray-300 px-4 sm:py-4 py-2 flex items-center justify-between lg:px-8">
        ...
        <div className="px-2 mt-6 sm:px-6 lg:px-8">
            <div className="mt-8 sm:block">
                <div className="align-middle inline-block min-w-full border-b border-gray-300">
                    {children}
                </div>
            </div>
        </div>
